          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-[#25D366] text-white text-xs font-bold hover:opacity-90 transition-all shadow-lg shadow-[#25D366]/20"
              >
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-[#1B4332] text-white text-xs font-bold hover:bg-[#2D6A4F] transition-all shadow-lg shadow-[#1B4332]/20"
              >
                <Mail className="w-3.5 h-3.5" /> Email
              </a>
              <a
                href={`sms:?body=${encodeURIComponent(bookingUrl)}`}
                className="flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-gray-800 text-white text-xs font-bold hover:bg-gray-700 transition-all shadow-lg shadow-gray-800/20"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#833AB4] via-[#E4405F] to-[#FCAF45] text-white text-xs font-bold hover:opacity-90 transition-all shadow-lg shadow-[#E4405F]/20"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-[#1877F2] text-white text-xs font-bold hover:opacity-90 transition-all shadow-lg shadow-[#1877F2]/20"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-white text-gray-700 border border-gray-200 text-xs font-bold hover:bg-gray-50 transition-all shadow-sm"
              >
