        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="relative flex-1 max-w-xs">
              ...
              <input type="text" value={search} onChange={e => setSearch(e.target.value)} placeholder="Search guests..." className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary shadow-sm" />
            </div>
          </div>
